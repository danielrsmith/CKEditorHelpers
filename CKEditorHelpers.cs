...
namespace System.Web.Mvc {
	public static class CKEditorHelpers {
		...
		/// </summary>
		private const string CK_Ed_Location = "/Scripts/library/ckeditor/";
		/// <summary>
        ...
        /// <summary>
        /// Create a strong-typed CKEditor instance - defaults ckEditorConfig
        /// </summary>
        /// <typeparam name="TModel"></typeparam>
        /// <typeparam name="TProperty"></typeparam>
        /// <param name="htmlHelper"></param>
        /// <param name="expression"></param>
        /// <param name="htmlAttributesDict"></param>
        /// <returns></returns>
        public static MvcHtmlString CKEditorFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IDictionary<string, object> htmlAttributesDict)
        {
            return CKEditorFor<TModel, TProperty>(htmlHelper, expression, null, htmlAttributesDict);
        }
